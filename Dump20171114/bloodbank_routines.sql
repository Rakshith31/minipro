...
--
/*!50003 DROP PROCEDURE IF EXISTS `Bloodsearch` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Bloodsearch`(in Bty char(3),in Qty float(10))
select * from BBANK where Btype = Bty AND Quantity >= Qty ;;
DELIMITER ;
