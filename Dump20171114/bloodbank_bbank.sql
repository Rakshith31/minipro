...
LOCK TABLES `bbank` WRITE;
/*!40000 ALTER TABLE `bbank` DISABLE KEYS */;
INSERT INTO `bbank` (`BID`, `Btype`, `Quantity`, `MID`) VALUES (1112,'A+',500,5556),(1112,'AB+',750,5556),(1111,'o+',350,5555),(1112,'AB+',500,5556),(1112,'ab+',500,5556);
/*!40000 ALTER TABLE `bbank` ENABLE KEYS */;
UNLOCK TABLES;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 trigger Olderrcrd
